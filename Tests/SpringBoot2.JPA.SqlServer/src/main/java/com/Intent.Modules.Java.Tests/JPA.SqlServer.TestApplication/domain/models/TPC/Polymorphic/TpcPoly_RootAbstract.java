...
public abstract class TpcPoly_RootAbstract implements Serializable {
    ...
    private TpcPoly_RootAbstract_Aggr poly_RootAbstract_Aggr;

    @OneToOne(optional = true, cascade = { CascadeType.ALL }, fetch = FetchType.LAZY)
    @JoinColumn(name="poly_root_abstract_comp_id", nullable = true)
    private TpcPoly_RootAbstract_Comp poly_RootAbstract_Comp;
