...
@MappedSuperclass
@Table(name = "TptPoly_RootAbstract")
@Getter
@Setter
@AllArgsConstructor
@NoArgsConstructor
@IntentManageClass(privateMethods = Mode.Ignore)
public abstract class TptPoly_RootAbstract implements Serializable {
    ...
    private TptPoly_RootAbstract_Aggr poly_RootAbstract_Aggr;

    @OneToOne(optional = true, cascade = { CascadeType.ALL }, fetch = FetchType.LAZY)
    @JoinColumn(name="poly_root_abstract_comp_id", nullable = true)
    private TptPoly_RootAbstract_Comp poly_RootAbstract_Comp;
