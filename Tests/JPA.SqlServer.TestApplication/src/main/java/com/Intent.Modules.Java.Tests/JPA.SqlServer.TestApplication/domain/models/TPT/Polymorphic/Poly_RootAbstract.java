...
public abstract class Poly_RootAbstract implements Serializable {
    ...
    private Poly_RootAbstract_Aggr poly_RootAbstract_Aggr;

    @OneToOne(optional = true, cascade = { CascadeType.ALL }, fetch = FetchType.LAZY)
    @JoinColumn(name="poly_root_abstract_comp_id", nullable = true)
    private Poly_RootAbstract_Comp poly_RootAbstract_Comp;
