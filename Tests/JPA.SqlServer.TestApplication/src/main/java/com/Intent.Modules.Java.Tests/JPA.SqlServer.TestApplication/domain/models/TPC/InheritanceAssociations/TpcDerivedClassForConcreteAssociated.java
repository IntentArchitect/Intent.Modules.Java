...
@Entity
@Table(name = "tpc_derived_class_for_concrete_associateds")
@Data
@AllArgsConstructor
@NoArgsConstructor
@IntentManageClass(privateMethods = Mode.Ignore)
public class TpcDerivedClassForConcreteAssociated implements Serializable {
    ...
    private TpcDerivedClassForConcrete derivedClassForConcrete;
